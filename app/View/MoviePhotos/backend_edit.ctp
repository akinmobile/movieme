...
<?php echo $this->Form->create('MoviePhoto'); ?>
	<fieldset>
		<legend><?php echo __('Edit Movie Photo'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('MoviePhoto.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('MoviePhoto.id'))); ?></li>
